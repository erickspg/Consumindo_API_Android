...
public class atuaisEFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_atuais_e, container, false);
        recyclerView = view.findViewById(R.id.listaAtuais);
